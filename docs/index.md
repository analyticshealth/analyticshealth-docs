...
This is the product story. The rest of the site is the engineering behind it.

- **[Architecture Overview](architecture/overview.md)** — the layered, event-driven design and the AWS services that power it
- **[Diagrams](architecture/diagram.md)** — ingestion flow, RAG pipeline, multi-tenant data layout
- **[RAG & Bedrock](architecture/rag-bedrock.md)** — how Ana retrieves context and reasons over it
- **[Multi-Tenant Security](architecture/security-multitenant.md)** — defense-in-depth for per-user isolation
- **[CI/CD Pipeline](architecture/cicd.md)** — GitHub OIDC, no long-lived credentials
- **[Cost — Baseline](cost/baseline.md)** & **[Scaling](cost/scaling.md)** — the real numbers at 1, 10, and 100 users
- **[Architecture Decisions (ADRs)](decisions/adr-0001-pgvector-vs-opensearch.md)** — every meaningful choice, documented
